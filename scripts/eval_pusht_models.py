...
def eval_random_policy(env, seeds, max_timesteps, copy_first_action, success_threshold):
...
if __name__ == "__main__":
    ...
    # eval_random_policy(env, seeds, max_timesteps, copy_first_action=False, success_threshold=success_threshold)
